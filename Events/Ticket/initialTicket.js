...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!["usa", "uk", "germany", 'quote'].includes(customId)) return;
        ...
        await guild.channels.create(`${member.user.username + "-" + COUNTER.toString().padStart(4, "0")}`, {
            ...
            const Embed = new MessageEmbed()
                ...
                .setDescription(`Ticket for: **${customId} proxies**\n\n
                Proxy sales are opened from 16:00 GMT to 04:00 GMT. Automatic payments and instant transfers will be available in our store soon.\n
                In the meantime, please check out our main website https://bottinghub.com/`)
